...
import static nokogiri.internals.html.internal.SharedConstants.AttrRangeKey;
import static nokogiri.internals.html.nodes.Range.AttributeRange.UntrackedAttr;
...
public class Attributes implements org.w3c.dom.NamedNodeMap, Iterable<Attribute>, Cloneable {
    ...
    public org.w3c.dom.Node setNamedItem(org.w3c.dom.Node arg) throws DOMException {
        W3CValidation.wrongDocument(ownerElement, (nokogiri.internals.html.nodes.Node)arg);
        W3CValidation.modificationAllowed(ownerElement);
        W3CValidation.attrHierarchyRequest(ownerElement, (nokogiri.internals.html.nodes.Node)arg);
