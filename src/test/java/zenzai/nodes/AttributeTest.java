...
public class AttributeTest {
    ...
    public void booleanAttributesAreEmptyStringValues() {
        Document doc = Parser.parse("<div hidden>", "");
    ...
    public void settersOnOrphanAttribute() {
        ...
        attr.setKey("three");
        String oldVal = attr.setValueWithReturn("four");
    ...
    public void canSetValueToNull() {
        ...
        String oldVal = attr.setValueWithReturn(null);
        assertEquals("one", attr.html());
        assertEquals("val", oldVal);

        oldVal = attr.setValueWithReturn("foo");
    ...
    void booleanAttributesAreNotCaseSensitive() {
        ...
        Document doc2 = parser.parseInput(html, "");
