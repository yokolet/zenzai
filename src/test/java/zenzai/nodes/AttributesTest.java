...
public class AttributesTest {
    ...
    @Test
    public void testIteratorUpdatable() {
        Attributes a = new Attributes();
        a.put("Tot", "a&p");
        a.put("Hello", "There");
    ...
    public void testBooleans() {
        ...
        Element el = Parser.parse(html, "").selectFirst("a");
    ...
    @Test
    public void cloneGetsUniqueUserDataMap() {
        Attributes one = new Attributes();
        String data = "Hello";
    ...
    @Test
    public void dontCloneNullUserData() {
        Element span1 = Parser.parse("<span id=1></span>", "").expectFirst("span");
    ...
    @Test
    public void sizeDoesNotIncludeInternal() {
