...
public class Selector {
    ...
    /**
     ...
     @throws zenzai.select.Selector.SelectorParseException (unchecked) on an invalid CSS query.
     */
    ...
    public static Stream<Element> selectStream(String query, Element root) {
        zenzai.helper.Validate.notEmpty(query);
    ...
    public static Stream<Element> selectStream(Evaluator evaluator, Element root) {
        zenzai.helper.Validate.notNull(evaluator);
        zenzai.helper.Validate.notNull(root);
    ...
    public static @Nullable Element selectFirst(String cssQuery, Element root) {
        zenzai.helper.Validate.notEmpty(cssQuery);
    ...
    /**
     ...
     @param css CSS query
     @return Evaluator
     @see zenzai.select.Selector selector query syntax
     @throws zenzai.select.Selector.SelectorParseException if the CSS query is invalid
     @since 1.21.1
     */
