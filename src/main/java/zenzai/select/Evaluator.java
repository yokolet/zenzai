...
import zenzai.nodes.XmlDeclaration;
...
import static zenzai.internal.StringUtil.normaliseWhitespace;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<zenzai.nodes.Attribute> values = element.attributes().asList();
            for (zenzai.nodes.Attribute attribute : values) {
