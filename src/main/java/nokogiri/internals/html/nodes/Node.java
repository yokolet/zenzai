...
public abstract class Node implements org.w3c.dom.Node, Cloneable {
    ...
    public org.w3c.dom.Node replaceChild(org.w3c.dom.Node newChild, org.w3c.dom.Node oldChild) throws DOMException {
        ...
        W3CValidation.nodeInChildren(this, (nokogiri.internals.html.nodes.Node)oldChild);
        W3CValidation.operationSupported(this);
        replaceChild((nokogiri.internals.html.nodes.Node)oldChild, (nokogiri.internals.html.nodes.Node)newChild);
        return oldChild;
    }
    ...
    public org.w3c.dom.Node appendChild(org.w3c.dom.Node newChild) throws DOMException {
        ...
        W3CValidation.wrongDocument(this, (nokogiri.internals.html.nodes.Node)newChild);
        W3CValidation.modificationAllowed(this, (nokogiri.internals.html.nodes.Node)newChild);
        W3CValidation.operationSupported(((nokogiri.internals.html.nodes.Node) newChild).parentNode());
     ...
     */
    public List<nokogiri.internals.html.nodes.Node> childNodes() {
        if (childNodeSize() == 0)
            return EmptyNodes;

        List<nokogiri.internals.html.nodes.Node> children = ensureChildNodes();
        List<nokogiri.internals.html.nodes.Node> rewrap = new ArrayList<>(children.size()); // wrapped so that looping and moving will not throw a CME as the source changes
     ...
     */
    public List<nokogiri.internals.html.nodes.Node> siblingNodes() {
        if (parentNode == null)
    ...
    protected void addChildren(int index, nokogiri.internals.html.nodes.Node... children) {
    ...
    protected void reparentChild(nokogiri.internals.html.nodes.Node child) {
        child.setParentNode(this);
    }

    protected void replaceChild(nokogiri.internals.html.nodes.Node out, nokogiri.internals.html.nodes.Node in) {
    ...
    protected void setParentNode(nokogiri.internals.html.nodes.Node parentNode) {
        Validate.notNull(parentNode);
